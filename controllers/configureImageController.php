    ...
    public function render($data)
    {
        ?>
            <div class="container">
                <div class="center">
                    ...
                    <a href="../views/addimage?idPhongTro=<?php echo $_GET['idPhongTro']; ?>">
                ...
                <table class="table" style="margin:auto;outline:auto">
                    ...
                    <tr>
                        ...
                        <th style="padding: 30px; outline: auto">
                            ...
                            <a href="<?php echo $_ENV['CONTROLLER_URL']; ?>api/delete_image?id=<?php echo $item['id']; ?>&idPhongTro=<?php echo $_GET['idPhongTro']; ?>" class="delete-image" data-id="<?php echo $item['id']; ?>">
        ...
        <script>
            ...
            btn.addEventListener('click', function(e) {
                ...
                const deleteUrl = '<?php echo $_ENV['CONTROLLER_URL']; ?>api/delete_image?id=' + id + '&idPhongTro=' + idPhongTro;
